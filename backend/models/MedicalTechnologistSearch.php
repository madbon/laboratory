...
/**
 * MedicalTechnologistSearch represents the model behind the search form of `backend\models\MedicalTechnologist`.
 */
class MedicalTechnologistSearch extends MedicalTechnologist
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['medical_technologist_c'], 'integer'],
    ...
    {
        $query = MedicalTechnologist::find();
